...
if ( ! function_exists( 'jspdx_theme_setup' ) ) :
	...
	function jspdx_theme_setup() {
		...
		register_nav_menus( array(
			'primary' => esc_html__( 'Primary', 'jspdx_theme' ),
		) );
...
function jspdx_theme_scripts() {
	wp_enqueue_style( 'jspdx_theme-style', get_stylesheet_uri() );

	wp_enqueue_script( 'jspdx_theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'jspdx_theme-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );

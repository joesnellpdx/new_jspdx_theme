...
function insert_page_heading(){
	...
	elseif( is_post_type_archive()) :
		$hero .= '<h1 class="entry-title title ' . $title_class . '">' . $add_icon . post_type_archive_title("", false) . '</h1>';
...
function my_search_form( $form ) {
    ...
    <button type="submit" id="searchsubmit" value="Submit" class="searchsubmit jspdx-icon-font-search-font" data-grunticon-embed style="background-image:none;"><span class="is-vishidden">Submit</span></button>
    </div>
    </form>';
...
function loadCSS_function(){
	...
	echo '/*! CSS rel=preload polyfill. Depends on loadCSS function. [c]2016 @scottjehl, Filament Group, Inc. Licensed MIT  */
(function( w ){

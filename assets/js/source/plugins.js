/*! jspdx_theme 1.0.0 filename.js 2016-03-08 10:48:59 AM */
(function(factory) {
...
(function($) {
    ...
    var heroSlider = function() {
        ...
        heroSlider.flexslider({
            ...
            animation: "fade",
            directionNav: true,
            prevText: "<i class='sr-icon-arrow-left4'></i> <span class='is-vishidden'>Previous</span>",
            nextText: "<span class='is-vishidden'>Next</span> <i class='sr-icon-arrow-right4'></i>",
            animationLoop: true,
            touch: false,
    ...
    var quotesSlider = function() {
        var theQuoteSlider = $("#quote-slider");
        theQuoteSlider.flexslider({
            slideshowSpeed: 14e3,
            animation: "fade",
            controlNav: false,
            directionNav: true,
            prevText: "<i class='sr-icon-arrow-left4'></i> <span class='h3 is-vishidden'>Previous</span>",
            nextText: "<i class='sr-icon-arrow-right4'></i> <span class='h3 is-vishidden'>Next</span>",
            animationLoop: true,
            touch: false,
            start: function(slider) {
                theQuoteSlider = slider;
                theQuoteSlider.addClass("loaded");
            },
            after: function(slider) {},
            init: function() {}
        });
